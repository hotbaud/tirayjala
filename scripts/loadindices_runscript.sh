...
export auth=$(bdconfig --getvalue bdshared_elasticsearch_admin):$(bdconfig --getvalue bdshared_elasticsearch_adminpass)
...
export ipaddr=$(bdconfig --getvalue bds_network_primaryip)
